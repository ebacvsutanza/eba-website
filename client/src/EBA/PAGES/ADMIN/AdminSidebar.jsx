      ...
      <div className="py-1 px-3 flex items-center gap-3 border border-gray-400 rounded-lg relative">
        ...
        {openModal &&
          (!notifDropdown ? (
            ...
            <p className="w-full max-w-70 h-50 overflow-auto no-scrollbar p-2 center-flex absolute md:left-[105%] bottom-18 md:bottom-0 bg-(--primary-bg) shadow-lg rounded-lg space-y-2 z-50">
              No new notification.
            </p>
          ) : (
